...
namespace GraphQLRestaurantReservation.Migrations
{
    ...
    [Migration("20231216160407_adddata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphQLRestaurantReservation.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraphQLRestaurantReservation.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraphQLRestaurantReservation.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2023, 12, 23, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8800),
                        ...
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2023, 12, 26, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8956),
                        ...
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2023, 12, 30, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8963),
            ...
            modelBuilder.Entity("GraphQLRestaurantReservation.Models.Menu", b =>
                {
                    b.HasOne("GraphQLRestaurantReservation.Models.Category", null)
                        .WithMany("Menus")
