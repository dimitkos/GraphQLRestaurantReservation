...
namespace GraphQLRestaurantReservation.Migrations
{
    /// <inheritdoc />
    public partial class adddata : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2023, 12, 23, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8800), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2023, 12, 26, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8956), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2023, 12, 30, 18, 4, 6, 988, DateTimeKind.Local).AddTicks(8963), "Celebrating a birthday." }
                });
